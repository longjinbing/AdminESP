package com.amani.eap.common.service;

import com.amani.eap.common.entity.TableResultEntity;
import com.amani.eap.common.util.EntityUtil;
...
public abstract class BaseService<M extends Mapper<T>, T> {
    ...
    public TableResultEntity<T> selectByQuery(Query query) {
        ...
        return new TableResultEntity<>(result.getTotal(), list);
    }
